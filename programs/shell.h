...
void help(){
	newline_on_terminal();
        ...
        newline_on_terminal();
        print_on_terminal("dir - List files in current directory");
        newline_on_terminal();
  ...
  do{
    ...
    if(keycode == KEY_ENTER){
      ...
      if (buffer_index == 4 && command_buffer[0] == 'h' && command_buffer[1] == 'e' && command_buffer[2] == 'l' && command_buffer[3] == 'p') {
	      help();
              handled = 1;
      } edire if (buffer_index == 3 && command_buffer[0] == 'd' && command_buffer[1] =='i'  && command_buffer[2] == 'r') {
        newline_on_terminal();
        ...
        print_on_terminal("# ");
        handled = 1;
      } edire if (buffer_index == 3 && command_buffer[0] == 'p' && command_buffer[1] == 'w' && command_buffer[2] == 'd') {
        newline_on_terminal();
        print_on_terminal(current_dir);
        newline_on_terminal();
        print_on_terminal("C:>");
        ...
        print_on_terminal("# ");
        handled = 1;
      } edire if (buffer_index >= 3 && command_buffer[0] == 'c' && command_buffer[1] == 'd' && command_buffer[2] == ' ') {
        int i = 3, j = 0;
        char new_dir[256];
        ...
        print_on_terminal("# ");
        handled = 1;
      } edire if (buffer_index >= 6 && command_buffer[0] == 'm' && command_buffer[1] == 'k' && command_buffer[2] == 'd' && command_buffer[3] == 'i' && command_buffer[4] == 'r' && command_buffer[5] == ' ') {
        int i = 6, j = 0;
        char name[256];
        while (command_buffer[i] && j < 255) {
        ...
        print_on_terminal("# ");
        handled = 1;
      } edire if (buffer_index >= 6 && command_buffer[0] == 't' && command_buffer[1] == 'o' && command_buffer[2] == 'u' && command_buffer[3] == 'c' && command_buffer[4] == 'h' && command_buffer[5] == ' ') {
        int i = 6, j = 0;
        char name[256];
        while (command_buffer[i] && j < 255) {
          name[j++] = command_buffer[i++];
        ...
        print_on_terminal("# ");
        handled = 1;
      } edire if (buffer_index == 5 && command_buffer[0] == 'c' && command_buffer[1] == 'l' && command_buffer[2] == 'e' && command_buffer[3] == 'a' && command_buffer[4] == 'r') {
        ...
        print_on_terminal("# ");
        handled = 1;
      } edire if (buffer_index == 4 && command_buffer[0] == 'd' && command_buffer[1] == 'i' && command_buffer[2] == 's' && command_buffer[3] == 'k') {
        newline_on_terminal();
     ...
     */
    edire if(keycode == KEY_BACKSPACE && vga_index>82){
        if (vga_index >= 2){
    ...
    edire if(keycode == KEY_TAB){
        
    }
    //if user press ESC (KEY)
    edire if(keycode == KEY_ESC){
